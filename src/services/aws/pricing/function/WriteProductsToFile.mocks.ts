          ...
          "Y6JK4U8NZRJW6Z2M.JRTCKXETXF": {
            "priceDimensions": {
              "Y6JK4U8NZRJW6Z2M.JRTCKXETXF.6YS6EN2CT7": {
                "unit": "Hrs",
                "endRange": "Inf",
                "description": "$0.0804 per Dedicated Unused Reservation Linux with SQL Web t3.micro Instance Hour",
                "appliesTo": [],
          ...
          "XHPE94YUY5Q6CS73.JRTCKXETXF": {
            "priceDimensions": {
              "XHPE94YUY5Q6CS73.JRTCKXETXF.6YS6EN2CT7": {
                "unit": "Hrs",
                "endRange": "Inf",
                "description": "$0.00 per Reservation Linux with SQL Web t3.micro Instance Hour",
                "appliesTo": [],
